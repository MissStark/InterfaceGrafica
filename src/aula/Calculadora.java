...
import java.awt.event.ActionEvent; //para evento/clique no botao
import java.awt.event.ActionListener;  //para o botao aparecer no visor
import javax.swing.JButton; //criacao de botao
import javax.swing.JFrame; //criacao de interface
import javax.swing.JTextField; //criacao de "visor"

public class Calculadora extends JFrame{ //IMPORTAR!
	...
	JButton btnDel = new JButton("←"); //ALT + 27
	...
	public Calculadora(){ //construtor
		...
		btnIgual.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				switch (op) {
				case "Soma":
					txtVisor.setText("" + calculo.soma(valor1, valor2));
					break;
				case "Menos":
					txtVisor.setText("" + calculo.sub(valor1, valor2));
					break;
				case "Div":
					txtVisor.setText("" + calculo.div(valor1, valor2));
					break;
				case "Mult":
					txtVisor.setText("" + calculo.mult(valor1, valor2));
					break;
